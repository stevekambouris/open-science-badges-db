# update_zotero_lib_2024-07-17.R -----------------------------------------------
#
# This script formats the OSB library export from 17th July 2024 and adds the
# new articles (correctly formatted) to the existing 2024-04-04 data set.
...
# The previous library ended with article 2257, so start numbering from 2258.
...
write_rds(osb_lib_updated,
          here("data", "osb_lib_with_study_id_2024-07-17.rds"))
write_excel_csv(osb_lib_updated,
                here("data", "osb_lib_with_study_id_2024-07-17.csv"),
                na = "",
                eol = "\r\n",
                quote = "all")
