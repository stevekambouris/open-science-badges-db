# update_zotero_lib_2024-04-04.R -----------------------------------------------
#
# This script formats the OSB library export from 4th April 2024 and adds the
# new articles (correctly formatted) to the existing 2020-02-21 data set.
...
# The previous library ended with article 1663, so start numbering from 1664.
...
write_rds(osb_lib_updated,
          here("data", "osb_lib_with_study_id_2024-04-04.rds"))
write_excel_csv(osb_lib_updated,
                here("data", "osb_lib_with_study_id_2024-04-04.csv"),
                na = "",
                eol = "\r\n",
                quote = "all")
